...
{#if !duplicate}
	...
	<Select
		...
		label="Périodicité"
		options={[
			{ value: 'quickwin', label: 'QuickWin (0-3 mois)' },
			{ value: 'short_term', label: 'Court terme (3-12 mois)' },
			{ value: 'medium_term', label: 'Moyen terme (12-18 mois)' },
			{ value: 'long_term', label: 'Long terme (>18 mois)' },
	...
	>
		...
		<Select
			...
			label="Type d'action"
			options={[
				{ value: 'organizational', label: 'Action organisationnelle' },
				{ value: 'technical', label: 'Action technique' },
				{ value: 'mixed', label: 'Action organisationnelle et technique' }
			]}
		/>
		<Select
			{form}
