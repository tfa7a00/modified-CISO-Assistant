...
class AppliedControl(
    ...
    PERIODICITY = [
        ("quickwin", _("QuickWin (0-3 mois)")),
        ("short_term", _("Court terme (3-12 mois)")),
        ("medium_term", _("Moyen terme (12-18 mois)")),
        ("long_term", _("Long terme (>18 mois)")),
    ...
    ACTION_TYPE = [
        ("organizational", _("Action organisationnelle")),
        ("technical", _("Action technique")),
        ("mixed", _("Action organisationnelle et technique")),
    ]
    ...
    periodicity = models.CharField(
        ...
        help_text=_("Catégorie de délai de remédiation (QuickWin, court terme, etc.)"),
    )

    complexity_level = models.CharField(
        max_length=20,
        choices=COMPLEXITY_LEVEL,
        null=True,
        blank=True,
        verbose_name=_("Niveau de complexité"),
        help_text=_("Complexité estimée de l'action (faible, moyen, important)."),
    )
    ...
    action_type = models.CharField(
        ...
        help_text=_("Action organisationnelle, technique ou mixte."),
    )
